...
let addTeeTimeForm = document.getElementById('add-tee_time-form-ajax');

// Modify the objects we need
addTeeTimeForm.addEventListener("submit", function (e) {
    ...
    let inputPartySize = document.getElementById("input-party_size");
    ...
    xhttp.open("POST", "/add-tee_time-ajax", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("tee_times-table");
    ...
    let partySizeCell = document.createElement("TD");
    ...
    partySizeCell.innerText = newRow.party_size;
